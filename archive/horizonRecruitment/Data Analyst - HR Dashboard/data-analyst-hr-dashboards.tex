...
3 years data analysis experience and business financial degree.
Experienced with creating report dashboard from large data set using tableau.
\end{cvparagraph}
  ...
  \cventry
    ...
    {Jan. 2013 - Jun. 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Utilized Tableau, and SSRS dashboard/visualization tools for data reporting and dashboard.}
        \item {Completed dealer's financial analysis dashboard by meeting their features and requirement.}
        \item {Improved existing and created new reports to push the company's finance incremental improvemnts.}
