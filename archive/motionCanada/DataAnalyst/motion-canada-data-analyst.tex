...
3 years experiences as data analyst in financial area.
Conducted quantitative and qualitative data analysis using R, Python.
\end{cvparagraph}
  ...
  \cvskill
    {Computer Science} % Category
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Python (Pandas, Matplotlib, NumPy, SciPy), R (RStudio), Advanced Microsoft Excel functions, Tableau, MS Project}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Jan. 2013 - Jun. 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Completed dealer's financial report by interpreting data, analyzing results using statistics techniques.}
