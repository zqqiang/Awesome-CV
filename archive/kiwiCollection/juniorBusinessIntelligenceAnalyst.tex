...
Recipient of a Bachelor's degree and professional certification in data analysis.
2 years of business experiences in business analyst role.
...
%---------------------------------------------------------
  \cvskill
    ...
    {
      \begin{cvitems}
        \item {Relational databases (MySQL), Math (statistics and probability), Regression analysis}
  ...
  \cvskill
    {Computer Science} % Category
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Advanced Microsoft Excel functions, Powerpoint, Tableau, Python (Pandas, Matplotlib, NumPy, SciPy), R (RStudio), MS Project}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {BCIT(British Columbia Institute of Technology) - GPA 88\%} % Institution
