...
Former Senior Credit Analyst and CFA level III Candidate. General understanding of U.S. Generally Accepted Acounting Principles.
\end{cvparagraph}
...
%---------------------------------------------------------
  \cvskill
    ...
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Quick Learner, Accuracy, Multitasking, Enthusiasm, Problem-solving, Process improvement, Interpersonal skills}
  ...
  \cventry
    ...
    {Jan. 2013 - Jun. 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Analyzed financial results (budgets and income) with consideration for the company's goals.}
        \item {Improved existing and created new forecasting, budgeting to push the company's finance results}
        \item {Completed dealer's financial analysis and converted data into actionable insights.}
        \item {Used SQL \& Advanced Excel functions to track and analyze sales, industry rankings and payment records data.}
        \item {Developed key risk financial modeling by Access/SQL to monitor financial risks and decreased costs by 8\%.}
        \item {Utilized Tableau, and SSRS dashboard/visualization tools performing financial and ad hoc analysis.}
      \end{cvitems}
    }
