...
%---------------------------------------------------------
  \cventry
    ...
    {ITalkBB Media.} % Organization
    {Richmond, BC} % Location
    {Jul. 2019 - Now} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Developed advanced Excel template to automate sales and payment record data analyze.}
        \item {Utilized CRM data management, personalization and marketing automation.}
        \item {Maintained records of purchase orders and coorinated plans for 30 employees.}
      \end{cvitems}
    }
