...
3 years of experience working with data \& visualization tools such as Tableau, 5 years financial experience.
...
%---------------------------------------------------------
  \cvskill
    ...
    {
      \begin{cvitems}
        \item {RegEx experience \& understanding, Relational databases (SQL Server), Math (statistics and probability), Regression analysis}
  ...
  \cventry
    ...
    {Jan. 2013 - Jun. 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Used SQL \& Advanced Excel to analyze client campaign, sales, and payment records data.}
        \item {Developed key risk indicators to monitor financial risks and decreased costs by 8\%.}
        \item {Utilized Tableau, and SSRS dashboard/visualization tools for data mining and exploration.}
        \item {Analyzed and provided recommendations to push improvements based on client data and industry rules.}
        \item {Improved existing and created new products to push the company's finance results.}
        \item {Provided support and training to other members as instructor.}
      \end{cvitems}
    }
